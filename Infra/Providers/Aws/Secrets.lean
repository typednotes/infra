...
/-
  AWS secret management (Secrets Manager), backed entirely by `Infra.Abstractions.Secrets` —
...
namespace Infra.Providers.Aws.Secrets
...
end Infra.Providers.Aws.Secrets
